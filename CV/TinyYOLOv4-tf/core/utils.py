"""
Utility file used to load YOLO weights, and elementary helper functions such as preprocessing
images, drawing bounding boxes, etc.
"""
...
def draw_bbox(image, bboxes, classes=read_class_names(cfg.YOLO.CLASSES),
    ...
    for i in range(num_boxes[0]):
        ...
        if class_name not in allowed_classes:
            ...
            cv2.rectangle(image, (c1[0], c1[1]), (c2[0], c2[1]), bbox_color, bbox_thick)
